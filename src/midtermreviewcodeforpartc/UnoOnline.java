...
public class UnoOnline {
    ...
    private void run() {
        ...
        // create password with validator
        PasswordValidator pa = new PasswordValidator();
        // use validtor to create a valid password
        String validPassword = pa.createPassword();
        User newUser = new User(userName, validPassword);
